  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 70% 90% at 50% 0%, rgba(74,222,128,0.02) 0%, rgba(74,222,128,0.008) 45%, transparent 75%)',
        }}
      />
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div
          ref={terminalRef}
          className="rounded-xl border border-white/[0.08] bg-[#0A0A0C] shadow-[0_0_80px_rgba(0,0,0,0.6)] overflow-hidden"
        >
