...
import TerminalMetricsStrip, {
  MetricInsightPanel,
  TABLE_PANEL_H,
} from '@/components/TerminalMetricsStrip'
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        >
          ...
          <TerminalMetricsStrip
            ...
            role={role}
            hoveredIndex={hoveredMetric}
            onHoverChange={setHoveredMetric}
          />
        </div>
      </div>
    </SectionReveal>
