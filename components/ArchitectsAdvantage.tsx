    ...
    >
      {showCrown && (
        ...
        <img
          ...
          alt=""
          draggable={false}
          className="pointer-events-none absolute -left-3 -top-7 z-10 h-auto w-[4.5rem] translate-x-[18px] -translate-y-[35px] -rotate-[5deg] sm:-left-4 sm:-top-8 sm:w-[5.25rem]"
          aria-hidden="true"
        />
      )}
